...
export default function Page() {
    ...
    const folderPath = 'gs://clevers-school-resources.appspot.com/BOOKS AND NOVELS/SET BOOK GUIDES';
    useEffect(() => {
                ...
                <div className="relative max-w-4xl mx-auto">
                    ...
                    <Card className="shadow-2xl  backdrop-blur-sm border border-gray-700 rounded-xl relative">
                        <CardHeader className="space-y-2 md:space-y-0 md:flex md:flex-row md:items-center md:justify-between p-4 md:p-6 border-b border-gray-700">
                            ...
                            <div className="text-sm text-blue-950 text-center md:text-right bg-gray-700/50 px-3 py-1 rounded-full">
                        ...
                        <CardContent className="p-4 md:p-6">
                            ...
                            {material.length === 0 && (
                                <div className="text-center py-8 text-red-600 bg-white rounded-lg border border-gray-700">
