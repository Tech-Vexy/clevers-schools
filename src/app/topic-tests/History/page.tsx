...
export default function History() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1qF6P1Rwx-xw1sNTCwJIHvtul7nb-_x5y': 'Form 1',
        '1SdQbq0DqOo3xXCzzgdvZWWscisPZf_fw': 'Form 2',
        '1WOPtS7c1u9XtZYMYMnsFS0Qhna7a036r': 'Form 3',
        '1I6YPgEbgOW3Ebfm4Jndgh4zhjGFYC7FA': 'Form 4'        
    }), []);
