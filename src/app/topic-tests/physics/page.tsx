...
export default function Physics() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1qRpa3d8friOJfwV9fZXHL7dmDOe_qLUc': 'Form 1',
        '1bjZ9C78rLVVVbAjeTOtrIo1cBxxYj8co': 'Form 2',
        '1NpLqc8pEl1fcEnfuoa4K6Bq4gDrIvyHO': 'Form 3',
        '1k6-FQLUJwj3Km6GYov7rwITt3HMy1oaA': 'Form 4'
