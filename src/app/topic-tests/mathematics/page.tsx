...
export default function Mathematics() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1nR1lrGbU6TdCEomb9eUYTqCQ1MAsKPXy': 'Form 1',
        '1qWloQP3IDwy9DrUdDqYhcWk-6ROtCtJg': 'Form 2',
        '1MfXLceSjCwsABFNNWew4oyvg36QG4dSe': 'Form 3',
        '17aj307FMvmjcYN5aQjY1qqzrOJMNtiQl': 'Form 4'
