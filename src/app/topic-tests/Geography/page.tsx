...
export default function Geography() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '14bFmCI2XwXHo2tUfXbaS6SEiOsj512sO': 'Form 1',
        '1M_yUEe7l3NCrFPyUiCTQY1CXn9ubE5zY': 'Form 2',
        '1Xb2dJiCp1V7lGeSVRFPvKzueqWRS7vDT': 'Form 3',
        '11ezjvUPtzeCuEQ-6Q7dDSeMTNb2ObuPl': 'Form 4'
    }), []);
