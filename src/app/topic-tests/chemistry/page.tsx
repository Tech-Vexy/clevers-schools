...
export default function Chemistry() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1QQaDYr57n7cmt-QnFwtfg_L3xDz9qgHn': 'Form 1',
        '1EKWaHU_vpW9VcUrKv5hrKRXaJ7VueIFc': 'Form 2',
        '1BNotr3bB-G4xaRk3sffSw3EwbsUAqtx0': 'Form 3',
        '1pncXwCJDG03iFijFW4UR2GcWwQKuQ1t8': 'Form 4'
    }), []);
