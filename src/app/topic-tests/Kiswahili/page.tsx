...
export default function Kiswahili() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '19mv4mF4DYaweVfyjmG44OkyxBX5klu0t': 'Old Notes',
        '1-7u69MNpLP8CjHNsVmET0MLCxFrO65Hh': 'Setbook Guides',
        '1bjIe3bzULQkdaJZb9QhHofo_W9tEwfUm': 'Revision Materials',
        '1CX3TDDGGQ9B3S-uT2FlseFABT9Rk0N00': 'Isimu Jamii'
