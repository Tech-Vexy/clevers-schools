...
export default function Business() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1FpyD1WmC2PnpTOR_8bj26aYbanhbRdX4': 'Form 1',
        '1olWjEkXUrar-71RnlaYdif_xlxXKxo0V': 'Form 2',
        '1mVZmBf_2CGCFBiDIfNPdP_ZLOd711OwT': 'Form 3',
        '1XIvvWUxeskf_XKTN6MImxvUJZzuyqXO7': 'Form 4'
    }), []);
