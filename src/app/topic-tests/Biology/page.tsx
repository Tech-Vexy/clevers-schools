...
export default function Biology() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1qg-YmoDHR8Fhbn1oTIdNdicFc_gikVXg': 'Form 1',
        '12oUgAi3v47l0xzvT9ZtBbeMrctzpsrfd': 'Form 2',
        '1qTS3e1Qbo6hMjxkWueThtWzOkpTDS8qB': 'Form 3',
        '1dRC4VSrE3mQtb515x3hYGvOq8YWFm5iE': 'Form 4'
    }), []);
