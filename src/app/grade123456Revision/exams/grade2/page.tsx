...
export default function Grade2RevisionSets() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
      '1YDSHF7bYPgLZNnN3RJnbWwQdoVxfqeZC': 'SET 1',
      '1a3rlc2-900xo-Mss0aH3KJrzNPXDnu1O': 'SET 2',
      '1LE_ZYuxAvuPKtsLajc9vlbeOsbr49-o1': 'SET 3',
      '1oJ18CSAOScxWW2pOyMiSBJEODc2AWccX': 'SET 4',
      '1AjGib0oZHwwMPneGT9Y_yLUOssKC5Aop': 'SET 5',
      '1HLvKDo2JLlijVRhU-BX7qoI7VcMLxsmt': 'SET 6',
      '1EGZIIN4g7PiTmlr5-vaZicfy2RiD8N6h': 'SET 7',
      '16Qddbv8FYUuozI2DLgBQtcFZv4UmreSO': 'SET 8',
      '1lhI7Um_yAleDwdFKoorV5LHY_DP0A8eO': 'SET 9',
      '1qjoSAGMgx7Z7k7yhgWQfGIYKs82TO6nA': 'SET 10',
      '1VPr3JC1-aEpNz7eY_u9hbYkkbDkigyXy': 'SET 11'
    }), []);
