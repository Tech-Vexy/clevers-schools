...
export default function Grade1RevisionSets() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
      '192izacZa-odg1f1S9O8Cvvifqetx_FLc': 'SET 1',
      '1U1zPuS8ko5zJyWIWcTiP8uTQAB1XBb5b': 'SET 2',
      '1BXX9relJKujOQJg_TnzD5HlINCLOV5sJ': 'SET 3',
      '1X3087xCDVGKBtDRGfKodayZZFpLKSirT': 'SET 4',
      '1Wx-eq2uahknFzF5CbQaAenSjY7V-guei': 'SET 5',
      '1hktJQZe2P8UUpC-ndscYzep9YuSYJsYe': 'SET 6',
      '1zL2Y0rjkDu2wGeGKnI-W5ULzuDf37gvi': 'SET 7',
      '1L0fMWl-mjaRHV-dmiQN5Xs-FmEJNr6p-': 'SET 8',
      '19qsNtQGdlvGmf8_SqMnO1tN3TsJSe1HL': 'SET 9',
      '1qbBnDbZ7tswKExR7VLrbi8oKR5spOcB2': 'SET 10'
    }), []);
