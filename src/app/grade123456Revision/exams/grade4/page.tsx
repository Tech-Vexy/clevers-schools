...
export default function Grade4RevisionSets() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
      '1dIApPhnt-2yfUwDOOocoMR8vT-OaSNVN': 'SET 1',
      '1lWJXp9JH7St8YhMIfykKXF_sWVogjQ0E': 'SET 2',
      '1ShsO29cZRlNWqhcpPmPN17n0nFkC9IUw': 'SET 3',
      '1OJSp48OIfmzCSuyg5sbLA1gHJvnplcS6': 'SET 4',
      '1J-KPmCoVfw3Ej8hjyNM0VjQcGotmgP5x': 'SET 5',
      '1bOTH3zEgIaj4KTUb3ZA5Vh_7rwVw9zz_': 'SET 6',
      '10DUoZGk273-HUD4AwtWFAT6ERq6tlO9r': 'SET 7',
      '1LAwLH1ctbf0rckg4c2M_hf1ucbDKmBA_': 'SET 8',
      '1TecYruIyM118bFSVdpNxfJlcsZrv4cJF': 'SET 9',
      '1vwm8HjNYlaeWH_A59myYX6deLOtnNPZz': 'SET 10',
      '1oADgolFotSzQATKIhRaR7g90atH7o5A1': 'SET 11'
    }), []);
