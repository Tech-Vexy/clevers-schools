...
export default function Grade5RevisionSets() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
      '1GI-jSi-kGkWS35EIU4_eWBDCjz-xt3On': 'SET 1',
      '1rEeJzn0UjYGltbLrdVIj1Vb0WcG4cEsf': 'SET 2',
      '13sm82c28Y4DdmjBxTzM-0lY5_LrLTBOu': 'SET 3',
      '154CqHuUEtNGlcY1P1D215P_f7ERqgDxi': 'SET 4',
      '1bk5D2p171Fg7mANdpUSC2EhKbmjW54xI': 'SET 5',
      '10Q2i1khWdLoIY2QN9V7AC4VxaqxyLBSy': 'SET 6',
      '1GlAZR6vt2iIlGDWesNHPPalbrSgVLAHQ': 'SET 7',
      '1pmK2jNvWg64rL9tN5MbClH1oUvqWoz70': 'SET 8',
      '1CjpJEK-01xWa1nlPZiXHMTlPolVGctXv': 'SET 9',
      '1WtCM54VeEkH9444FqSor-nufusiVKFPb': 'SET 10'
