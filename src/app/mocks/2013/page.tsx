...
export default function CountyMocks2013() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1Ndjglv_utl4e_Xf5QuyVPEJByVLHr1ml': 'French',
        '1XwQwuCVpU802-xCr7TJxoNguyVvfT1DY': 'English',
        '1zdyM8T0NJtXR7GwyXBtyIgAkPSCpgGrA': 'CRE',
        '1aVOGzHZ4eSs6Wd7FEQnAf6Sm7WTw8UTS': 'Computer Studies',
        '1-AXdwKvJZVHVX3vhfKZtLnl1o1IIT5ha': 'Chemistry',
        '1_uR7MKN16-6j860FoGPI9VT8tHvplYg-': 'Business',
        '1g1ihwbyTPHGP-9Jqw8Oyc8661QURotEg': 'Biology',
        '1FqdPNfMVjilfwpMLUs_ygQyLpdpWlCmr': 'Art & Design',
        '1YaoUvcVuUeeNQxqrrZUw3HsEdnFBlXVu': 'Agriculture',
        '1IeBDl-BZkkKFdx1bmGJhZ1bZ3QlOlLts': 'Physics',
        '1nA0queeuxPf3h3Q6x3TQFUMTzPlwMLHW': 'Kiswahili',
        '1kB_Bk8j9_ohfxRdmJMzqp7Hql3FRlvVH': 'Mathematics',
        '1sTqxLIwO9uGWC0OTGVqdpBUgHw_SJiVS': 'Home Science',
        '1SQkgSeFBKxsZLwpAUy3YejA4-ZHM8fGR': 'History',
        '1xLpz4jboqlbqsubNi69Jfr4l-0mSlr3I': 'Geography'
