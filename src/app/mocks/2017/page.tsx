...
export default function CountyMocks2017() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1oA3cageegNyi05SO2nRCWre4MD0DIQS3': 'Westlands',
        '1raAeZ-5oKmxqosBPZ9caNR4UzuLHuwhe': 'Sukemo',
        '1I_zcXWkQmmh1DUfvTa-LgN_x6M2lohuQ': 'Perfector',
        '16QHHR-0VMgfRGmCiG0wCuHfxjQw9PLRA': 'Muungano joint',
        '1M9AnWnFdLTNGUdFoYnwRX8VWsVrq7V5J': 'Muranga',
        '1WRKkeaX4zu6fBPM1fGCI9BIsocC57dt6': 'Mokasa',
        '1HFbJZPZJlgmk1SLxFPQe5EnrYrWwp9Ys': 'Set 7',
        '12C0Dx0hVbikGt8EYRHrIwhLvK5IWH0cb': 'Kirinyaga',
        '12ussTtI_V2cRtFcc2osDf3aTDtJ_MiRm': 'Kassu',
        '1xEjiVp8mBGeiaj24feoV1xuqVyDYtyrZ': 'High Score',
        '11XFRwozyXPyniUXWFhnG1OJZHhz4fZrs': 'Compliant',
        '14JWdQIrF6bGfYmlnwH9YSAt2qYOhs7iX': 'Cekana',
