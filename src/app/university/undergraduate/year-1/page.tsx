...
export default function DocumentList() {
    ...
    const folderPath = 'gs://clevers-school-resources.appspot.com/University/undergraduate/FIRST YEAR';
    ...
    const handleDocumentClick = (file: FileItem) => {
        ...
        router.push(`/document/view/${encodeURIComponent(file.name)}?${searchParams.toString()}`);
    };
                                ...
                                {currentFiles.map((file) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <h3 className="text-sm md:text-base font-semibold text-black group-hover:text-emerald-300 truncate">
                                                {file.name}
                                            </h3>
                                        </div>
                                    </div>
