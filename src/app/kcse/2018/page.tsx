...
export default function Page() {
    ...
    const folderPath = 'gs://clevers-school-resources.appspot.com/KNEC PAST PAPERS/2018 KNEC KCSE';
    ...
    const handleDocumentClick = (file: FileItem) => {
        // Updated to use the new document viewer page
        router.push(`/document/${encodeURIComponent(file.name)}?fileData=${encodeURIComponent(JSON.stringify(file))}`);
    };
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            <div 
                id="content-area"
                className="flex-1 overflow-y-auto px-4 py-8 bg-amber-200"
            >
