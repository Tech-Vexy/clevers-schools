...
export default function Form3Notes() {
    ...
    const folderIds = useMemo(() => [
        ...
        '13tPjQrotqG-jeaE8bPgQs-VT-pPKol4n',
        '1xdH_-XMcSbo7pVBMBjRlOJaish5t2XF1',
        '1gRMk5GfWYNSvgIq16y-IG-1Le5Lm8TJ-',
        '1TWVUdQx279nEjplnC-J8VRfvzWGkM1Mx',
    ...
    const folderNames: { [key: string]: string } = {
        ...
        '1YX1wnZPyN8WmaJgcFD2bNBkFoiM4falk': 'Maths',
        '1izW0AS9vd9OP-aZTLeLFRsXa0ZMqy0DX': 'Kiswahili',
        '13tPjQrotqG-jeaE8bPgQs-VT-pPKol4n': 'IRE',
        '1xdH_-XMcSbo7pVBMBjRlOJaish5t2XF1': 'Home Science',
        '1gRMk5GfWYNSvgIq16y-IG-1Le5Lm8TJ-': 'History',
        '1TWVUdQx279nEjplnC-J8VRfvzWGkM1Mx': 'Geography',
