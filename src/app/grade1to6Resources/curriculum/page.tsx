...
export default function Grade1To8Curriculum() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        ...
        '15D59iBDUxICxMMELmFrqwjHDB3-auqku': 'Grade 1',
        '1RUnNA3DDwov14FSF0g-ochaK6qynKaB_': 'Grade 2',
        '14gI97maiinYTly_Co1JCN29k6w4GVYDC': 'Grade 3',
        '15VF7ZsbybBroOJtC2lJE3tywhOKAmQc8': 'Grade 4',
        '1-blTzAqexcAdDfGAFDF0vcyTdGqZOXKa': 'Grade 6',
        '1wR8yw2mxqhqyzLalS3v85z6aa5sjFuXo': 'Grade 7',
        '1tfNwaf5KMnLzgwxGOqBZl9tT2qnPGI6R': 'Grade 8'
