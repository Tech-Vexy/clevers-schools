...
export default function Grade2Resources() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '19TG2x956qR1kvXGV6FqD4zE5n151hHO4': 'Assessments',
        '1huXhTNmulkh9Mz06BvVkVIgK2eyFHV-O': 'Assignments',
        '1RUnNA3DDwov14FSF0g-ochaK6qynKaB_': 'Curriculum Designs',
        '1cmuShS6rizDUGGnyO5jt0P4V7ZbMxx7j': 'Exams',
        '1jw5b4uaxIO9WI83lTTrUqAwwRqzXIC4e': 'Lesson Plans',
        '1du5PSN5b1FdkKSw8KKAquvZwjU22q_u1': 'Notes',
        '15MOJS_Q5ad2Wn2ctqdirAETN01_gBfof': 'Schemes of Work'
    }), []);
