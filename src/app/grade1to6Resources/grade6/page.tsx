...
export default function Grade6Resources() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1s8II4N3wDCZZLhNXxJZQ86gpnEdd_sfw': 'Assessments',
        '14AGTgwJ8VYoOMBmX10A3kHZpGQkt7ZgW': 'Assignments',
        '1-blTzAqexcAdDfGAFDF0vcyTdGqZOXKa': 'Curriculum Designs',
        '1Wi8oUKsNR-Tbv4ld2_VwIFWGGN5PIMjl': 'Exams',
        '1GYkSXZ8f9Rg0BU0Fxk8yjCrO1rBMeYAE': 'Lesson Plans',
        '17iqNr7dscgyXyZYDsP2_DBU_HNrxPIE8': 'Notes',
        '1GKvtQJ1x39RQc3b5JOexGFCPrd-5csYI': 'Schemes of Work',
        '1V9yG7WDlm7FAmvHIx6cECfKNFikAWaFn': '2022 KEPSEA'
    }), []);
