...
export default function Grade3Resources() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1bRSVDTjzrrcoN3GBzE9AJvTuOaQ7lVOO': 'Assessments',
        '1huXhTNmulkh9Mz06BvVkVIgK2eyFHV-O': 'Assignments',
        '14gI97maiinYTly_Co1JCN29k6w4GVYDC': 'Curriculum Designs',
        '1BLD-k2oV3eYljUznH88GcOdKdbsgZWBK': 'Exams',
        '1s2SU98EqJ9TRiFEhLiEPv9h8NuC6-UJq': 'Lesson Plans',
        '1y2QYl-byR5AIpEyLVuWjR0OhWy8A_z2F': 'Notes',
        '1yv6zZWv03Hkd3yGaZswlD7f3_Wk2QBDL': 'Schemes of Work'
    }), []);
