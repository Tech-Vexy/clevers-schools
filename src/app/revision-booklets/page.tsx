...
export default function RevisionBooklets() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '13-OdW-pg2vHt4CmXVuZRmej9qM6oF-OS': 'TopMark',
        '1n6gVGwne6Xrz3Ld71WzXF7vCIjT20XiV': 'Other Boklets',
        '1qObffFDp6qXbv8gyUwE7JLpCqNJkxTxb': 'Revision Mocks',
        '1hUSMU0iVJnW2eRZV52I2NIaHL7J7yBhV': 'KCSE Revision Booklets',
        '1WD_Awhav3oI2b8JfAW3FoOgWWwN-h07p': '2011 Booklets'
