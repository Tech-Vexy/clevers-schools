...
// Constants
const FOLDER_ID = '19kOF-tYjhitMklNKbCySSAusswH6745Y';
...
// Main Component
export default function Sunshine2019() {
                ...
                <div className="relative max-w-3xl mx-auto">
                    ...
                    <Card className="shadow-2xl backdrop-blur-sm border border-gray-700 rounded-xl relative">
                        <CardHeader className="space-y-2 md:space-y-0 md:flex md:flex-row md:items-center
                            ...
                            <CardTitle className="text-xl uppercase md:text-2xl text-emerald-400 text-center
                                                md:text-left font-bold">
                          2019 SUNSHINE HIGH SCHOOL
                            </CardTitle>
                            <SearchBar
                                value={searchQuery}
