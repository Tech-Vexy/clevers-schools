...
export default function Grade5Resources() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        ...
        '1llnEsZr1Ly9DSy88vjyLHJPD1KMcT2kv': 'Assignments',
        '15QZlaZl2hO0y6QtzKgaklBOTy3Owj1xx': 'Curriculum Designs',
        '1MwihuE-yXSelhf8_5je7wxcCJA-kJpj3': 'Exams',
        '1sTRB7zelslrDVpyADea17Go61nW0-7uW': 'Lesson Plans',
        '1EdWk0bbS4Z-4FeenYZ6x_ddGTRUihVn2': 'Notes',
        '1XXCd7VwbXr78z1D5aI1nTulVLFAW4khd': 'Schemes of Work'
    }), []);
