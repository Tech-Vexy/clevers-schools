...
export default function Grade1Resources() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        ...
        '15D59iBDUxICxMMELmFrqwjHDB3-auqku': 'Curriculum Designs',
        '1jULALE7brYTJiNh7yreumITzIE_tqYS4': 'Exams',
        '17I2nQsq7fJJcc-JpGzG71G1bIkqHbIZK': 'Lesson Plans',
        '1skRyIRNFdFB9wHykb2gQfqjEY6hG16tl': 'Notes'
    }), []);
