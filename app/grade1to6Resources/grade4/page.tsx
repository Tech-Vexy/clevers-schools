...
export default function Grade4Resources() {
    ...
    const folderNames = useMemo(() => ({
        '1lgKdqT8XEAuAv8gAghjlPKkQ6MN5tK-8': 'Assessments',
        '1huXhTNmulkh9Mz06BvVkVIgK2eyFHV-O': 'Assignments',
        '15VF7ZsbybBroOJtC2lJE3tywhOKAmQc8': 'Curriculum Designs',
        '1h--NvpwqHifwQZBW3bjC88AODCIpRPzl': 'Exams',
        '1CZMW4DYcJA20GsgwDPJRIb9ouxyRg-RM': 'Lesson Plans',
        '12okmspQvWIUDFfRXgUQ2ztBfCMrbLo5M': 'Notes',
        '1j_Kg8S1ExP1mQtFifvWBZwwuDmy4igh4': 'Schemes of Work'
    }), []);
    ...
    const filteredMaterial = useMemo(() => {
        ...
        return material.filter(file =>
            ...
            folderNames[file.folderId as keyof typeof folderNames].toLowerCase().includes(lowercaseQuery)
        );
