...
// Constants
const FOLDER_ID = '1rmDCI2N2jjdgcWuAeP2ktJ-JoTg9KxpF';
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <h3 className="text-sm md:text-base font-medium text-blue-500 text-wrap group-hover:text-emerald-300 truncate">
                    {file.name}
                </h3>
                {file.lastModified && (
...
// Main Component
export default function Grade7Schemes() {
