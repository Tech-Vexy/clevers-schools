...
export default function Form1Plan() {
    ...
    const folderNames: { [key: string]: string } = {
        ...
        '1hzBvzhbtBu5bFdgA9f7S_acLoButyKix': 'Physics Lesson Plans',
        '1T53RJxy68U8p6ZkeiX67KBPhBtRT1eK8': 'Mathematics Lesson Plans',
        '1n4cvsYetoTOh-dTDqm42Z31RlwHhR2Cc': 'Form 1,2,3 Lesson Plans',
        '12nd1lpE7Dt1yN8u4aJ_agtRzPhgJIrkT': 'Chemistry Lesson Plans',
        '1vYg3kKl9tstIVSs_onkBz7032jYMnBVL': 'Biology Lesson plans'
    };
