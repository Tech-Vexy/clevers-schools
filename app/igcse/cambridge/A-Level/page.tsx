...
export default function CambridgeALevel() {
    ...
    const folderNames: { [key: string]: string } = useMemo(() => ({
        '1G3v_bXhZIgA8kIDUGr3gmcFDVTZ6MdzA': 'Travel & Tourism',
        '1xv8jLfvNGlre6PD0yG6WFkyKLXui-X-m': 'Psychology',
        '1H8DFpGIjprFy485-CF79F60H0C6xWnb6': 'Physics',
        '1ihSa8AHv91sNXaTN-V7GSigi97DgIbvV': 'Music',
        '1yG0AIRJ42_4Akz8quuA7pOiWCnVpQDjC': 'History',
        '1_0AM7lzBue7p3oP3Bie1A0LqoCXnpoII': 'Geography',
        '1tWagwDVRRnLPF5SeN9YXkPqkdRDZjVY3': 'French',
        '1J7wPLUWPIhfQQ1fIceYZZAVlOVgNmo8c': 'English',
        '1WF1YvoLwR_G0S6bej7mvu7laiz7G11JW': 'Computing',
        '10FVco3cSLQQjm0dQXmZorq-OMpxREjkV': 'Computer Science',
        '1xTVqRBt_GSMW1aJRsqG0Pa-bPot7LEgC': 'Chemistry',
        '1H6UzyzrQ3SBaCF-fWwoTZA1PiRkvRVOU': 'Business',
        '1pcL5mEugtN5fVURQpkaFyf8XBejenXDQ': 'Biology',
        '12pi98RV5-I2fzksMbqNCHLjdBo8lkSNp': 'Art & Design',
        '1HA0rvSJN2I0c1wYTQpZAh74S0teL1kCI': 'Accounting'
    }), []);
                    ...
                    <Card className="shadow-2xl h-full backdrop-blur-sm border border-gray-700 rounded-xl relative">
                        <CardHeader className="space-y-2 md:space-y-0 md:flex md:flex-row md:items-center md:justify-between p-4 md:p-6 border-b border-gray-700">
                            <CardTitle className="text-xl md:text-2xl text-emerald-400 text-center md:text-left font-bold">
                                IGCSE CAMBRIDGE A-LEVEL RESOURCES
                            </CardTitle>
